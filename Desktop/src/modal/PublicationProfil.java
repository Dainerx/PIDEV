...
public class PublicationProfil {
    ...
    public PublicationProfil(Integer id, LocalDate date, String contenu, String picpath) {
        this.id = id;
        this.date = date;
    ...
    public PublicationProfil(LocalDate date, String contenu, String picpath, Profile idProfil) {
        this.date = date;
        this.contenu = contenu;
        this.picpath = picpath;
    ...
    public String toString() {
        return "Services.PublicationProfil[ id=" + id + " ]";
    }
