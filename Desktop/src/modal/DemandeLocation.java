...
public class DemandeLocation{
    ...
    public DemandeLocation(int id_membre, String nom_membre, String nom_location, Date date_debut, Date date_fin, float cout) {
    ...
    public DemandeLocation(int id_membre, String nom_location, Date date_debut, Date date_fin, float cout) {
        this.id_membre = id_membre;
        this.nom_location = nom_location;
        this.date_debut = date_debut;
        this.date_fin = date_fin;
