...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oussama.api' => 'getOussama_ApiService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Pidev\GestionTrajetsBundle\Form\RegistrationType A Pidev\GestionTrajetsBundle\Form\RegistrationType instance
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Pidev\GestionTrajetsBundle\Form\RegistrationType();
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PidevGestionTrajetsBundle', ($this->targetDirs[3].'/app/Resources/PidevGestionTrajetsBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PidevGestionTrajetsBundle', ($this->targetDirs[3].'/src/Pidev/GestionTrajetsBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'VreshTwilioBundle', ($this->targetDirs[3].'/app/Resources/VreshTwilioBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'VreshTwilioBundle', ($this->targetDirs[3].'/vendor/vresh/twilio-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'NomayaSocialBundle', ($this->targetDirs[3].'/app/Resources/NomayaSocialBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'NomayaSocialBundle', ($this->targetDirs[3].'/vendor/nomaya/social-bundle/Nomaya/SocialBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'authentication.handler.login_success_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Pidev\GestionTrajetsBundle\Security\LoginSuccessHandler A Pidev\GestionTrajetsBundle\Security\LoginSuccessHandler instance
     */
    protected function getAuthentication_Handler_LoginSuccessHandlerService()
    {
        return $this->services['authentication.handler.login_success_handler'] = new \Pidev\GestionTrajetsBundle\Security\LoginSuccessHandler($this->get('router'), $this->get('security.authorization_checker'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('O8sKyrTXsk', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RFC28vDT7Q', 0, 'Rl8hwvy57i-9bxcxlZn0v9', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'piweb', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Pidev/GestionTrajetsBundle/Entity'))), 'Pidev\\GestionTrajetsBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('PidevGestionTrajetsBundle' => 'Pidev\\GestionTrajetsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fc98c9d7657d166014af2e7b601a24903cdd6d875aca0ecf6d82853584ff847a');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Pidev\\GestionTrajetsBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('resetting@example.com' => 'Demo'), 'resetting' => array('resetting@example.com' => 'Demo'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Pidev\\GestionTrajetsBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'Pidev\\GestionTrajetsBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Pidev\\GestionTrajetsBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Pidev\\GestionTrajetsBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'Pidev\\GestionTrajetsBundle\\Entity\\Membre');
    }
     ...
     */
    protected function getOussama_ApiService()
    {
        return $this->services['oussama.api'] = new \Vresh\TwilioBundle\Service\TwilioWrapper('ACfef81828dc8c64a7517d0e7126acab3f', 'fd1b8f43a66a33b480d208dea4f1a362', '2010-04-01', 1);
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('dainerxx.21@gmail.com');
        $a->setPassword('21541010oOdi@iedzszsde_password');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AppBundle', 8 => 'FOSUserBundle', 9 => 'AsseticBundle', 10 => 'PidevGestionTrajetsBundle', 11 => 'FOSJsRoutingBundle', 12 => 'VreshTwilioBundle', 13 => 'NomayaSocialBundle', 14 => 'DebugBundle', 15 => 'WebProfilerBundle', 16 => 'SensioDistributionBundle', 17 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Pidev/GestionTrajetsBundle/Resources/views'), 'PidevGestionTrajets');
    ...
    {
        return $this->services['twilio.capability'] = new \Vresh\TwilioBundle\Service\TwilioCapabilityWrapper('ACfef81828dc8c64a7517d0e7126acab3f', 'fd1b8f43a66a33b480d208dea4f1a362');
    }
    ...
    {
        return $this->services['twilio.lookups'] = new \Vresh\TwilioBundle\Service\TwilioLookupsWrapper('ACfef81828dc8c64a7517d0e7126acab3f', 'fd1b8f43a66a33b480d208dea4f1a362');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('25737acc1e879c73080b6ef80f9557f2fa23c0dc');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b9OH5r9ZVG', 0, 'Rl8hwvy57i-9bxcxlZn0v9', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'PidevGestionTrajetsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Pidev/GestionTrajetsBundle'),
                    'namespace' => 'Pidev\\GestionTrajetsBundle',
                ),
                ...
                'VreshTwilioBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/vresh/twilio-bundle'),
                    'namespace' => 'Vresh\\TwilioBundle',
                ),
                'NomayaSocialBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/nomaya/social-bundle/Nomaya/SocialBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PidevGestionTrajetsBundle' => 'Pidev\\GestionTrajetsBundle\\PidevGestionTrajetsBundle',
            ...
            'secret' => '25737acc1e879c73080b6ef80f9557f2fa23c0dc',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '25737acc1e879c73080b6ef80f9557f2fa23c0dc',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'dainerxx.21@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '21541010oOdi@iedzszsde_password',
            ...
            'fos_user.model.user.class' => 'Pidev\\GestionTrajetsBundle\\Entity\\Membre',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'resetting@example.com' => 'Demo',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'Pidev\\GestionTrajetsBundle\\Form\\RegistrationType',
            ...
            'assetic.bundles' => array(
                ...
                8 => 'FOSUserBundle',
                9 => 'AsseticBundle',
                10 => 'PidevGestionTrajetsBundle',
                11 => 'FOSJsRoutingBundle',
                12 => 'VreshTwilioBundle',
                13 => 'NomayaSocialBundle',
                14 => 'DebugBundle',
            ...
            'links.facebook' => array(
                'network' => 'facebook',
                'url' => 'http://www.facebook.com/yann.chauvel',
                'theme' => 'default',
            ),
