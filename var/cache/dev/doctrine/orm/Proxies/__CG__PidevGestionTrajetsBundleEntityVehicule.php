 ...
 */
class Vehicule extends \Pidev\GestionTrajetsBundle\Entity\Vehicule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Pidev\\GestionTrajetsBundle\\Entity\\Vehicule' . "\0" . 'id', '' . "\0" . 'Pidev\\GestionTrajetsBundle\\Entity\\Vehicule' . "\0" . 'marque', '' . "\0" . 'Pidev\\GestionTrajetsBundle\\Entity\\Vehicule' . "\0" . 'matricule', '' . "\0" . 'Pidev\\GestionTrajetsBundle\\Entity\\Vehicule' . "\0" . 'modele', '' . "\0" . 'Pidev\\GestionTrajetsBundle\\Entity\\Vehicule' . "\0" . 'gamme'];
        }
